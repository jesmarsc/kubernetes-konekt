 ...
 <div class="image-widescreen margin-top-image">
		...
		<nav id="nav" class="navbar navbar-expand-lg">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul>
					...
					<li class="active visible-sm visible-xs"><a class="nav-link" href="${pageContext.request.contextPath}/"> Home </a></li>
	...
	<div class="container  mx-1 my-4 col-sm-10 col-md-10 col-lg-12">
		...
		<form:form action="/provider/upload" modelAttribute="newClusterForm">
			...
			<div class="form-group mx-sm-4 mb-2 text-muted">
			<div class="col-xs-4">
...
<body>
	...
	<div class="container  mx-1 my-4 col-sm-10 col-md-10 col-lg-12">
		...
		<!--<h3>Upload New Cluster IP</h3>
		<form:form action="/provider/upload" modelAttribute="newClusterForm">
<!-- Action ll be to send to confirmation page and validate -->
